...
const RightContent=(props)=>{
    ...
    <div className='right-content'>
        ...
        {openModal&&<CreateModal setOpenModal={setOpenModal} currentDate={currentDate} setCurrentDate={setCurrentDate} event={event} setEvent={setEvent} retrieveEvents={retrieveEvents}/>}
